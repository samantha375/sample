...
if ($block_vpn == "on") {
    ...
    $ip = getIP();
    $WOLFApi = "https://blackbox.ipinfo.app/lookup/". $ip;
    
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $WOLFApi);
