...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true">
        ...
        'slide-in-back': animate.isSlideInBack() }">
                    ...
                    event: {
                        ...
                        setBackButtonState: view_onSetIdentityBackButtonState } }">
                                                    ...
                                                    <div id="idDiv_SAOTCC_Title" class="row text-title" role="heading" aria-level="1" data-bind="text: twoWayPollingNeeded ? str['CT_SAOTCAS_STR_Title'] : str['CT_SAOTCS_STR_Title']">Approve sign in request</div>
                                                    <div class="row text-body">
                                                        ...
                                                        <div id=" idDiv_SAOTCC_Description" class="text-block-body overflow-hidden" data-bind="text: description">We're calling your phone. Please answer it to continue.
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div data-bind="css: { 'position-buttons': !tenantBranding.BoilerPlateText &amp;&amp; !twoWayPollingNeeded }">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-24">
                                                                <div class="text-13">
                                                                    <div data-bind="css: { 'form-group': !twoWayPollingNeeded }">
    ...
    css: { 'no-margin-bottom': removeBottomMargin }" style="display: none;">
                ...
                preventTabbing: primaryButtonPreventTabbing" value="Verify" style="display: none;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
