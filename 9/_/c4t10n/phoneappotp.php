                        ...
                        setBackButtonState: view_onSetIdentityBackButtonState } }">
                                            ...
                                            <div class="row text-body">
                                                <div data-bind="component: { name: 'proof-image-control', params: { type: proofImageType, small: true, animate: twoWayPollingNeeded } }">
                                                    <img class="tile-img small" role="presentation" pngsrc="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_code_ea014b224eb1c04ac2f7cb85c43cc034.png" svgsrc="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_code_f7ab697e65b83ce9870a4736085deeec.svg" data-bind="imgSrc, css: { 'small': small }" src="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_code_f7ab697e65b83ce9870a4736085deeec.svg"><!-- /ko -->
                                                </div>
